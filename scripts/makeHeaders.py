...
l+=[("FIRM_VERSION", "\""+sys.argv[1]+"\""),
    ...
    # ("CN_NINJHAX_URL", "\"http://10.0.0.7/~ianburgwin/ninjhax2.x-nodebug/p/\""),
    ("CN_NINJHAX_URL", "\"http://ihaveamac.github.io/ninjhax2.x/p/\""),
	("OUTNAME", "\""+sys.argv[7]+"\"")]
l+=[("BUILDTIME", "\""+datetime.now().strftime("%Y-%m-%d %H:%M:%S")+"\"")]
l+=[("HAX_NAME_VERSION", "\"*hax 2.5 - no debug mod 1.0\"")]
l+=[("HB_NUM_HANDLES", "16")]
